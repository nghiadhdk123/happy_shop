					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input type="email" class="form-control" id="mail" name="email"
								placeholder="Email người dùng" disabled value="{{ $user->email }}">
								@error('email')
								<div><span class="requie">{{ $message }}</span></div>
								@enderror
						</div>
						<div class="row">
							<div class="form-group col-6">
								...
								<input type="text" class="form-control" id=""
									name="phone" placeholder="Số điện thoại người dùng" value="{{ $user->phone }}">
									@error('phone')
									<div><span class="requie">{{ $message }}</span></div>
									@enderror
							</div>
							...
							<div class="form-group col-6">
								...
								<input type="text" class="form-control" id=""
									name="address" placeholder="Địa chỉ người dùng" value="{{$user->address }}">
							</div>
						</div>
