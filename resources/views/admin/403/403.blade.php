...
<body>
	<div class="maincontainer">
		<div class="bat">
			<img class="wing leftwing"
				src="/403/canh.png">
			<img class="body" src="/403/than.png"
				alt="bat">
	...
	<h1 class="errorcode">Lỗi 403</h1>
	<div class="errortext">Bạn không có quyền vào đây ! <a href="{{ route('dash.admin') }}" style="color:#FBD130;">Đi về đi ^-^</a></div>
</body>
